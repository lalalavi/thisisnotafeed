...
class Constants(BaseConstants):
    ...
    total_time = 60 # 120 #(2 min)
    IMG_ON_PAGE = 6

    # Used to be 2 minutes, now it's 1
...
class SplitScreen(Page):
    ...
    def vars_for_template(player):    
        ...
        # if player.round_number in participant.hr_n:
        #     player.sReward = 'HR'
        # else:
        #     player.sReward = 'LR'
...
class Posting(Page):
    ...
    def vars_for_template(player):
        ...
        if player.sReward == 'LR':
            vImages = participant.LRexplore 
        else:
            vImages = participant.HRexplore
